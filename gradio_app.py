...
with gr.Blocks() as demo:
    ...
    with gr.Accordion("Settings", open=False):
        with gr.Tab(label='Language Model'):
            ...
            temperature = gr.Slider(minimum=0.0, maximum=2.0, step=0.01, value=0.6, label="Temperature")
            top_p = gr.Slider(minimum=0.0, maximum=1.0, step=0.01, value=0.9, label="Top P")
            max_new_tokens = gr.Slider(minimum=128, maximum=4096, step=1, value=4096, label="Max New Tokens")
